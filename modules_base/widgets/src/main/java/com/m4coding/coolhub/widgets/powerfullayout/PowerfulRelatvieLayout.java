...
/**
 * @author mochangsheng
 * @description 可设置 圆角、边框、阴影（5.0以下不支持)、宽高比例的RelativeLayout
 */
public class PowerfulRelatvieLayout extends RatioRelativeLayout implements IPowerfulLayout {

    private PowerfulILayoutHelper mLayoutHelper;

    public PowerfulRelatvieLayout(Context context) {
        this(context, null, 0);
    }

    public PowerfulRelatvieLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PowerfulRelatvieLayout(Context context, AttributeSet attrs, int defStyleAttr) {

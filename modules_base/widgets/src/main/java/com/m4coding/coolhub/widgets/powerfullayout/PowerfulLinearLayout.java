...
/**
 * @author mochangsheng
 * @description  可设置 圆角、边框、阴影（5.0以下不支持)、宽高比例的LinearLayout
 */
public class PowerfulLinearLayout extends RatioLinearLayout implements IPowerfulLayout {

    private PowerfulILayoutHelper mLayoutHelper;

    public PowerfulLinearLayout(Context context) {
        this(context, null, 0);
    }

    public PowerfulLinearLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PowerfulLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {

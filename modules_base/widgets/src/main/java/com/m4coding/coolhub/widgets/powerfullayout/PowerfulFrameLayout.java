...
import com.m4coding.coolhub.widgets.ratiolayout.RatioFrameLayout;

/**
 * @author mochangsheng
 * @description 可设置 圆角、边框、阴影（5.0以下不支持)、宽高比例的FrameLayout
 */
public class PowerfulFrameLayout  extends RatioFrameLayout implements IPowerfulLayout {
    ...
    public PowerfulFrameLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PowerfulFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {

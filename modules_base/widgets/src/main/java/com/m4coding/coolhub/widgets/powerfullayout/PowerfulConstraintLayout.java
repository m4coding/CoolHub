package com.m4coding.coolhub.widgets.powerfullayout;
...
import com.m4coding.coolhub.widgets.powerfullayout.helper.PowerfulILayoutHelper;
import com.m4coding.coolhub.widgets.ratiolayout.RatioConstraintLayout;

/**
 * @author mochangsheng
 * @description 可设置 圆角、边框、阴影（5.0以下不支持)、宽高比例的ConstraintLayout
 */
public class PowerfulConstraintLayout extends RatioConstraintLayout implements IPowerfulLayout {

    private PowerfulILayoutHelper mLayoutHelper;

    public PowerfulConstraintLayout(Context context) {
        this(context, null, 0);
    }

    public PowerfulConstraintLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PowerfulConstraintLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        mLayoutHelper = new PowerfulILayoutHelper(context, attrs, defStyleAttr, this);
    }
    ...
    public void setRadiusAndShadow(int radius, @IPowerfulLayout.HideRadiusSide int hideRadiusSide, int shadowElevation, final float shadowAlpha) {
    ...
    public void setRadius(int radius, @IPowerfulLayout.HideRadiusSide int hideRadiusSide) {
